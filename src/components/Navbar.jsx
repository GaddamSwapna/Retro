...
const Navbar = () => {
  ...
  return (
    <nav className="w-full sticky top-0 bg-primary shadow-md hover:primary/50 transition duration-300 dark:bg-darkPrimary z-50  " ref={navRef}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link to="/body/home" className="flex-shrink-0 text-text dark:text-darkText text-2xl font-bold">
            MyApp
          </Link>
